...
class Multimedia:
    ...
    def completed(self):
        input("Completed, press anykey to go back")
        self.__init__()
#----------------------------------------------------------------
class vlc:
    def __init__(self):
...
class GIMP():
    ...
    def installed(self):
        usr = getpass.getuser()
        return (os.path.isdir(f"/home/{usr}/snap/gimp"))
    def install(self):
...
class adcity():
    ...
    def installed(self):
        usr = getpass.getuser()
        return (os.path.isdir(f"/home/{usr}/snap/audacity"))
...
class office:
    ...
    def completed(self):
        input("Completed, press Enter key to return to main menu")
        self.__init__()
...
class Chromium():
    def __init__(self):
        if not self.installed() or self.installed4():
            self.install()
    ...
    def installed4(self):             # to check if installed from other source
...
class pycharm():
    ...
    def installed(self):                #to check in snap
        usr = getpass.getuser()
        return (os.path.isdir(f"/home/{usr}/snap/pycharm-community"))
...
class vscode():
    ...
    def installed(self):
        usr = getpass.getuser()
        return (os.path.isdir(f"/home/{usr}/snap/code"))   
    def install(self):
